...
import { createHeroSprite, createAntiHeroSprite, createHeroWithEyes, createAntiHeroWithEyes } from "./components/hero.js"
...
// Предзагружаем все варианты глаз (9 позиций)
for (let x = -1; x <= 1; x++) {
  for (let y = -1; y <= 1; y++) {
