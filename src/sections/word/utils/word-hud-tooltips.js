...
//
// Standard HUD hover zones (progress, small hero, life)
//
...
/**
 * Registers standard WORD section HUD hover tooltips (progress, small hero, life)
...
export function setupStandardHudTooltips(k, ctx) {
  const { levelIndicator, topPlatformHeight } = ctx
